              ...
              <ul class="sub-menu p-2 pl-0" style="width: 250px">
                <li class="menu-item-has-children pb-2">
                  ...
                  <ul class="sub-menu p-2" style="width: 240px">
                    ...
                    <li>
                      <a href="driving-license-renewal.php">Driving License Renewal</a>
                    </li>
                    <li>
                      <a href="duplicate-driving-license.php">Duplicate Driving License</a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="international-driving-permit.php">International Driving Permit</a>
                    </li>
                    <li>
                      <a href="issue-noc-of-driving-license.php">Issue NOC of Driving License</a>
                    </li>
                    <li>
                      <a href="submit-noc-of-driving-license.php">Submit NOC of Driving License</a>
                    </li>
                  </ul>
                </li>
                <li class="menu-item-has-children">
                  ...
                  <ul class="sub-menu p-2" style="width: 240px">
                    <li>
                      <a href="transfer-of-vehicle-ownership.php">Transfer of Vehicle Ownership</a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="renewal-of-registration-certificate.php"
                        >Renewal of Registration Certificate</a
                      >
                    </li>
                    <li>
                      <a href="chanege-of-address-in-registration-certificate.php"
                        >Change of Address in Registration Certificate</a
                      >
                    </li>
                    <li>
                      <a href="hypothecation-cancellation.php">Hypothecation Cancellation</a>
                    </li>
                    <li>
                      <a href="issue-noc-of-vehicle.php">Issue NOC of Vehicle</a>
                    </li>
                    <li>
                      <a href="submit-noc-of-vehicle.php">Submit NOC of Vehicle</a>
                    </li>
                    <li>
                      <a href="vehicle-insurence.php">Vehicle Insurence</a>
                    </li>
                  </ul>
                </li>
              </ul>
                          ...
                          >
                            <li class="menu-item-has-children pb-2">
                              ...
                              <ul class="sub-menu p-2" style="width: 240px">
                                ...
                                <li>
                                  <a href="issue_noc_of_driving_license.php"
                                    >Issue NOC of Driving License</a
                                  >
                                </li>
                                <li>
                                  <a href="submit_noc_of_driving_license.php"
