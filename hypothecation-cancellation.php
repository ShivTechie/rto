<?php
  $meta = [
    "title" => "Hypothecation Cancellation - RTO Service in Pune",
  ...
  breadCrum("Hypothecation Cancellation")
 ?>
                  ...
                  >
                    <div class="course-single-bottom-please-note">
                      ...
                      <ul class="content-ul">
                        <li>
                          ...
                          Before the RTO Authority. (Only in Case of Car of 4W
                          Vehicle of age less than 3 years old.)
                        </li>
                      </ul>
                    </div>
                    <div class="course-single-bottom-reference">
                      <div class="m-3">
                        ...
                        <ul class="content-ul">
                          <li>
                            The Motor Vehicles Act 1988 (Section 51 of Chapter
                            IV)
                          </li>
                          <li>
                            The Central Motor Vehicles Rules 1989 (Rule 61)
                          </li>
                          <li>
                            Official Transport Department Website:
                            <strong>
                              <a
                                href="https://parivahan.gov.in/parivahan/en/content/hp-termination"
                                target="_blank"
                                >Follow Link</a
                              >
                            </strong>
