<?php
  $meta = [
    "title" => "Submit NOC of Vehicle - RTO Service in Pune",
  ...
  breadCrum("Submit NOC of Vehicle")
 ?>
                ...
                <div class="tab-content" id="productTabContent">
                  ...
                  >
                    <div class="course-description">
                      <h3>Submit NOC of Vehicle</h3>
                      <p>
                        <strong>
                          Submit No Objection Certificate (N.O.C.) of a vehicle
                          in new RTO.
                        </strong>
                      </p>
                      <p>
                  ...
                  >
                    ...
                    <table border="1">
                      <tbody>
                        ...
                        <tr>
                          <td>
                            In Case Owner is Residing in a Rental House, Owner
                            Has to Submit:
                            <ul>
                              <li>
                        ...
                        <tr>
                          <td>
                            Vehicle Invoice (Only in Case of Vehicle from Other
                            State)
                          </td>
                          <td>Photocopy</td>
                        </tr>
                ...
                <div class="tab-content" id="productTabContent">
                  ...
                  >
                    <div class="course-single-bottom-please-note">
                      ...
                      <ul class="content-ul">
                        <li>
                          If the Vehicle is From Other State, Then the Vehicle
                          Shall Be Produced Before the RTO Authority for
                          Inspection and Shall Pay One Time Tax to the Concerned
                          RTO.
                        </li>
                        <li>
                          If the NOC is not Submitted within 15 days from the
                          date of issue, fine will be incurred.
                        </li>
                      </ul>
                    </div>
                    <div class="course-single-bottom-reference">
                      <div class="m-3">
                        ...
                        <ul class="content-ul">
                          <li>
                            The Motor Vehicles Act 1988 (Section 48 of Chapter
                            IV)
                          </li>
                          <li>
                          ...
                          <li>
                            ...
                            <strong>
                              <a
                                href="https://parivahan.gov.in/parivahan/en/content/no-objection-certificate"
                                target="_blank"
                                >Follow Link</a
                              >
                            </strong>
