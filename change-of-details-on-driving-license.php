<?php
  $meta = [
    "title" => "Change of Details on Driving Licence - RTO Service in Pune",
  ...
  breadCrum("Change of Details on Driving Licence")
 ?>
                ...
                <div class="tab-content" id="productTabContent">
                  ...
                  >
                    <div class="course-description">
                      <h3>Change of Details on Driving Licence</h3>
                      <p>
                        <strong>
                          Change of Address, Name or Date of Birth in Driving
                          Licence.
                        </strong>
                      </p>
                      <p>
                        <strong>
                          When a Driving Licence holder changes his/her
                          residence or wants to change the Name in Driving
                          Licence or want to change the Date of Birth. Request
              ...
              <div class="course-single-bottom">
                <div class="tab-content" id="productTabContent">
                  <div
                    ...
                    aria-labelledby="description-tab"
                  >
                    <h5 class="m-3">Required Documents: (A+B)</h5>
                    <table border="1">
                      <thead>
                        <tr>
                    ...
                    <table border="1">
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <ul>
                              <li>Government Gazette/ Marriage Certificate</li>
                            </ul>
                          </td>
                          <td>Photocopy</td>
                        </tr>
                    ...
                    <table border="1">
                      <thead>
                        <tr>
                          <th colspan="2">
                            <h6>For Change in Date of Birth: (B)</h6>
                          </th>
                        </tr>
                      </thead>
                      <tbody>
            ...
            <aside class="sidebar-area">
              <div class="widget widget_info">
                <div class="driving-license-renewal">
                  ...
                  <p class="price-tag">
                    <del>₹1500</del> <strong>₹1300</strong>
                  </p>
                  <hr />
