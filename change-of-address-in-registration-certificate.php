<?php
  $meta = [
    "title" => "Change of Address in Registration Certificate - RTO Service in Pune",
  ...
  breadCrum("Change of Address in Registration Certificate")
 ?>
                  ...
                  >
                    <table border="1">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>
                            In Case Owner is Residing in a Rental House:
                            <ul>
                              <li>
                  ...
                  >
                    <div class="course-single-bottom-reference">
                      <div class="m-3">
                        ...
                        <ul class="content-ul">
                          <li>
                            The Motor Vehicles Act 1988 (Section 49 of Chapter
                            IV)
                          </li>
                          <li>
                          ...
                          <li>
                            ...
                            <strong>
                              <a
                                href="https://parivahan.gov.in/parivahan/en/content/address-change"
                                target="_blank"
                                >Follow Link</a
                              >
                            </strong>
