<?php
  $meta = [
    "title" => "Duplicate Registration Certificate - RTO Service in Pune",
  ...
  breadCrum("Duplicate Registration Certificate")
 ?>
                  ...
                  >
                    <table border="1">
                      ...
                      <tbody>
                        <tr>
                          <td>
                            Police 'Lost and Found' Report
                            <a
                              href="https://punepolice.gov.in/report-us/lost-and-found"
                              target="_blank"
                              >(Follow Link)</a
                            >
                          </td>
                  ...
                  >
                    ...
                    <div class="course-single-bottom-reference">
                      <div class="m-3">
                        ...
                        <ul class="content-ul">
                          <li>
                            The Motor Vehicles Act 1988 (Section 41 of Chapter
                            IV)
                          </li>
                          <li>
                          ...
                          <li>
                            ...
                            <a
                              href="https://parivahan.gov.in/parivahan/en/content/duplicate-rc"
                              target="_blank"
                              >Follow Link</a
                            >
                          </li>
              ...
              <div class="widget widget_info">
                <div class="driving-license-renewal mb-3">
                  <h3 class="widget_title text-center">
                    Duplicate Registration Certificate <br />
                    (Two Wheeler)
                  </h3>
                  <p class="price-tag">
