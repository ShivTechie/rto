<?php
  $meta = [
    "title" => "Issue NOC of Vehicle - RTO Service in Pune",
  ...
  breadCrum("Issue NOC of Vehicle")
 ?>
                  ...
                  >
                    <table border="1">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>New Owner’s Aadhar</td>
                          <td>Photocopy</td>
                        </tr>
                        <tr>
                          <td>Old Owner’s Aadhar</td>
                          <td>Photocopy</td>
                        </tr>
                        <tr>
            ...
            <aside class="sidebar-area">
              <div class="widget widget_info">
                <div class="driving-license-renewal">
                  <h3 class="widget_title text-center">Issue NOC of Vehicle</h3>
                  <p class="price-tag">
