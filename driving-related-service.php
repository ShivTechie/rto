<?php
$meta = [
  "title" => "Driving Licence Related Services - RTO Service in Pune",
...
breadCrum("Driving Licence Related Services")
 ?>
            ...
            <div class="course-single">
                ...
                <div class="tab-content" id="productTabContent">
                  ...
                  >
                    <div class="course-description">
                      <h3>Driving Licence Related Services</h3>
                      <p>
                      ...
                      <p>
                        A Driving Licence is an official document certifying
                        that the holder is suitably qualified to drive a motor
                        vehicle. Licences are issued by the Motor Vehicles
                        Department through its Regional Transport Offices (RTO).
                        An individual of 16 years of age and above (for a
                        non-gear two wheeler upto 55 cc) and 18 years and above
                        (for a geared two wheeler and four wheeler) can apply
                        for Driving Licence.
                      </p>
                      <p>
              ...
              <div class="course-single-mid">
                <div class="tab-content" id="productTabContent">
                  <div
                    ...
                    aria-labelledby="description-tab"
                  >
                    <div class="service d-flex align-items-center m-4">
                      <img
                        src="assets/img/service/driver-license.png"
                        alt="Edura"
                        class="service-image w-0 ml-50"
                      />
                      <div class="ml-50">
                        <a href="#">
                          <h3>How to Get Your Driving Licence?</h3>
                        </a>
                        <p class="">
              ...
              <div class="course-single-bottom">
                <div class="tab-content" id="productTabContent">
                  ...
                  >
                    <div class="course-description">
                      <h5>Driving Licence Related Services</h5>
