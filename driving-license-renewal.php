<?php
$meta = [
  "title" => "Driving Licence Renewal - RTO Service in Pune",
...
breadCrum("Driving Licence Renewal")
 ?>
                ...
                <div class="tab-content" id="productTabContent">
                  ...
                  >
                    ...
                    <div class="course-single-bottom-please-note">
                      <h6>Please Note</h6>
                      <p>
                        If the Driving Licence is already expired, then it will
                        incur penalty fees as:
                      </p>
                      <p>
                        <em>
                          Rs. 200 for 1st Year after Licence Expiration The
                          applicant would have to apply for ReTest and Revalid,
                          If the Driving Licence has expired more than a year
                          ago.
                        </em>
                      </p>
                    </div>
